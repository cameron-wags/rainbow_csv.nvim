...
command! RbSelect call rainbow_csv#select_from_file("normal")
...
command! -range -nargs=+ Select call rainbow_csv#run_select_cmd_query(<line1>, <line2>, <q-args>)
command! -range -nargs=+ Update call rainbow_csv#run_update_cmd_query(<line1>, <line2>, <q-args>)
