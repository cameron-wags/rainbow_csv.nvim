...
" TODO treat all non-csv files as monocolumn
...
command! RainbowSelect call rainbow_csv#select_from_file()
command! RbRun call rainbow_csv#finish_query_editing()
command! RainbowRun call rainbow_csv#finish_query_editing()
