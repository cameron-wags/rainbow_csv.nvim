...
function main() {
    ...
    let [input_path, query_file, encoding, delim, policy, comment_prefix, output_delim, output_policy] = cmd_args;
    ...
    let warnings = [];
    rbql_csv.query_csv(query, input_path, delim, policy, output_path, output_delim, output_policy, encoding, warnings, false, comment_prefix).then(() => handle_worker_success(warnings, output_path)).catch(e => handle_worker_error(e));
}
